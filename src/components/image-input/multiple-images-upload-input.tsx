...
import { uploadImageToLocalAction } from "./components/image-upload-to-local-action";
...
interface MultipleImagesUploadInputProps {
  ...
  folder: CloudinaryFolderName[keyof CloudinaryFolderName];
  id?: string;
}
...
const uploadImage = async (
  ...
  try {
    ...
    // const resp = await uploadImageToLocalAction({
    //   image: file,
    //   signData,
    // });
    // return resp;
